        ...
        <form method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    <td>Room No</td>
                    <td>
                        <input type="text" name="room_number" placeholder="Enter room number" title="Enter Room No"
                            required>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Room Price</td>
                    <td><input type="text" name="room_price" placeholder="Enter Room Price " title="Room Price"
                            required>
                    </td>
                </tr>
                <tr>
                    <td>Room Description</td>
                    <td><input type="text" name="room_detail" placeholder="Enter Room Desc " title="detail" required>
                    </td>
                </tr>
