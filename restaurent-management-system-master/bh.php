...
<style>
    #foem-1{
        ...
        position: absolute;
        height: 800px;;
        background: url('img/h2.jpg') center center/cover no-repeat;
        border-radius:20px;
    }
    #foem-1 h1{
        text-align:center;
    ...
    form{
        ...
        padding: 30px;
        background-color: rgba(182 193 230 / 50%);
    }
    form tr{
       padding:20px;
    }
        ...
        <form action="" method="post">
            <?php
              ...
              if($row>0)
              {
                ...
                <tr>
                  <td>Booking Date:</td>
                  <td><input type="date" name="date"  title="Check in" required></td>
