...
if (isset($_POST['register'])) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) { // it will be executed if username or email is already taken
            ...
            $qry = "INSERT INTO `registered_users` (`name`, `username`,`gen`,`email`, `password`,`address`,`city`,`state`,`mno`,`adno`) VALUES ('$_POST[fullname]','$_POST[username]','$_POST[gen]','$_POST[email]','$password','$_POST[addr]','$_POST[city]','$_POST[state]','$_POST[mno]','$_POST[adno]')";
