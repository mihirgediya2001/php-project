...
<body style="background-image: url('./img/ac3.jpg'); background-repeat:no-repeat;   background-size: 100%;
">
<div id="r1-container">
    <?php
    $conn = connection();
        ...
        while ($row = $loginUser->fetch_assoc()) {
            ...
            <form action="r1.php" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>Members</td>
                        <td><input type="text" name="members" title="members" pattern="[0-9]" required></td>
                    </tr>
                    <tr>
                        <td>Room Type</td>
                        <td>
                    ...
                    <tr>
                        <td>No of Rooms</td>
                        <td><input type="text" name="noofroom" title="No of Room" pattern="[0-9]" required ></td>
                    </tr>
                    <tr>
