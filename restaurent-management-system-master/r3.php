...
<h1>BOOK NOW YOUR NON AC ROOM</h1>
    <table>
        ...
        <tr>
            <td>Check in Date</td>
            <td><input type="date" name="cin" title="cindate"> </td>
            <td>Check out Date</td>
            <td><input type="date" name="cout" title="coutdate"></td>
        </tr>
        <tr>
            <td>Members</td>
        ...
        <tr>
            <td>Room Type</td>
            <td><input type="text" name="roomtype" title="roomtype"></td>
        </tr>
        <tr>
            <td>No of Rooms</td>
            <td><input type="text" name="noofroom" title="No of Room"></td>
        </tr>
        <tr>
    ...
    <?php
        ...
        $rno=$row['roomno'];
            ...
            if($run==true)
            {
                mysqli_query($sql,"UPDATE `nonac` SET `status`='book' WHERE `roomno`='$rno' ");
