<?php
   ...
   function sendMail($email,$reset_token)
   {
      ...
      try {
        ...
        $mail->Username   = 'shrutikathiriya1413@gmail.com';                     //SMTP username
        $mail->Password   = 'shruti@123';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('shrutikathiriya1413@gmail.com', 'sk');
        ...
        $mail->Subject = 'Password Reset Link from shruti kathiriya';
